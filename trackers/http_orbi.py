...
class http_orbi(tracker):
	def __init__(self, *args, **kwargs):
		...
		DomoticzEx.Status('Started address:{}, port:{}, user:{}, keyfile:{}, class:{} and poll interval:{}'.format(self.tracker_ip, self.tracker_port, self.tracker_user, self.tracker_keyfile, self.__class__.__qualname__, self.poll_interval))
	...
	def connect_orbi(self):
		...
		DomoticzEx.Status(self.tracker_ip + ' Initialized as Netgear Orbi')
	...
	def stop_now(self):
		...
		try:
			...
			DomoticzEx.Error(self.tracker_ip + ' Closing error: ' + str(e))
		super().stop_now()